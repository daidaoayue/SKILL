...
> 本 skill 的所有改写遵循 `_REGISTER-SPEC.md`（与各 skill 文件夹同级）的学术语体红线（L1 书面体；禁反问句、口号碎句、口语词、中文第一人称；致谢节豁免）。
...
- **短句植入**：在关键论断处加 5-8 词完整陈述句（例："该现象与预期相悖。"、"这一偏差不可忽视。"）；短句须为合格学术陈述句，不得为口号、反问或碎句
